...
/**
 * The <code>GeneRemote</code> class provides a Java RMI-compliant interface to the 
 * M-functions from the files:
 * <pre>
 *  E:\\program\\matlab\\GeneratePointsOnSphere.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>GeneRemote</code> 
 ...
 * generate RMI server proxy objects for instances of testGene.Gene.
 */
public interface GeneRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the 
     * <code>GeneratePointsOnSphere</code> M-function with 2 input arguments.  
     *
     ...
     */
    public Object[] GeneratePointsOnSphere(int nargout, Object... rhs) throws RemoteException;
